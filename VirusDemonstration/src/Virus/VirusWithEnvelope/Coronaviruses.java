...
public class Coronaviruses extends VirusWithEnvelope {
    ...
    public Coronaviruses(String name, String family, String structure, List<String> mechanism, AcidNucleic acidNucleic, Capsid capsid, Envelope envelope, Glycoprotein glycoprotein) {
