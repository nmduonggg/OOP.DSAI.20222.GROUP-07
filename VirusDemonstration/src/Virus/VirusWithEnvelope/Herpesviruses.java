...
public class Herpesviruses extends VirusWithEnvelope {
    ...
    public Herpesviruses(String name, String family, String structure, String mechanism, AcidNucleic acidNucleic, Capsid capsid, Envelope envelope, Glycoprotein glycoprotein) {
