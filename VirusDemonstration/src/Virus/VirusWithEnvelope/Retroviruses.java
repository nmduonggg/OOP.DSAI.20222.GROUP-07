...
public class Retroviruses extends VirusWithEnvelope {
    ...
    public Retroviruses(String name, String family, String structure, String mechanism, AcidNucleic acidNucleic, Capsid capsid, Envelope envelope, Glycoprotein glycoprotein) {
